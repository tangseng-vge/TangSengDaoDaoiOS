...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongAdvanced/WuKongAdvanced.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongFile/WuKongFile.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongGroupManager/WuKongGroupManager.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongMoment/WuKongMoment.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WuKongSmallVideo/WuKongSmallVideo.framework"
